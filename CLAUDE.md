...
- **Embeddings / RAG** : HF Inference API (Hugging Face) — modèle `paraphrase-multilingual-MiniLM-L12-v2` (384 dims, multilingue) — appelé via `embedTexts()` dans l'Edge Function avec le secret `HF_TOKEN`
